...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
            if (res.data.length) {
                console.log('there is somthing to show');
    ...
    searchInput.on('keyup', function (e) {
        //if thery aren't pressing up, down or enter, who cares!
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(38), __webpack_require__(9)))
